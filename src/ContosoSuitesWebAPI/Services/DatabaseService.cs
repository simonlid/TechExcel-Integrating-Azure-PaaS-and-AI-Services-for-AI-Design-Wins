...
public class DatabaseService : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Get all bookings for a hotel after a specific date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("The minumum date")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Get missing hotel rooms for a booking.")]
